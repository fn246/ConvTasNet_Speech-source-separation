...
class AudioDataset(data.Dataset):
    ...
    def __init__(self, json_dir, batch_size, sample_rate=16000, segment=4 , cv_maxlen=8.0):
        """
        Args:
...
#    json_dir, batch_size = sys.argv[1:3]
    #fatemeh
    json_dir, batch_size='D:/Amir Kabir University/thesis/conv-tasnet/Conv-TasNet-master/outdata/tr',1
    dataset = AudioDataset(json_dir, int(batch_size))
    data_loader = AudioDataLoader(dataset, batch_size=1,num_workers=4)
